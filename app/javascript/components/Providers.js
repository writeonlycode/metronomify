...
const Providers = ({ children }) => {
  ...
  const [settingsMetronome, setSettingsMetronome] = useState({
    bpm: 60,
    beats: 4,
    emphasis: true,
    muted: false,
  ...
  const [settingsPomodoro, setSettingsPomodoro] = useState({
    duration: dayjs.duration(300000),
    enabled: true,
  });
  ...
  return (
    ...
    >
      <SettingsMetronomeContext.Provider
        value={[settingsMetronome, setSettingsMetronome]}
      >
        <SettingsPomodoroContext.Provider
          value={[settingsPomodoro, setSettingsPomodoro]}
        >
